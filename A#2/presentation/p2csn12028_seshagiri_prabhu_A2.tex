...
\usebackgroundtemplate{
	\tikz[overlay,remember picture] \node[opacity=1,  xshift=.9cm, yshift=-2.4cm, at=(current page.center)] {
	\includegraphics[scale=0.5]{images/Avaz_App_Autism.jpg} };
}
\begin{frame}
...
{
\usebackgroundtemplate{
	\tikz[overlay,remember picture] \node[opacity=1,  xshift=4.5cm, yshift=-3.2cm, at=(current page.center)] {
	\includegraphics[scale=1]{images/Avaz-logo-small.png}};
}
\begin{frame}
...
{
\usebackgroundtemplate{
	\tikz[overlay,remember picture] \node[opacity=1,  xshift=3.8cm, yshift=-2.5cm, at=(current page.center)] {
	\includegraphics[scale=0.18]{images/Child-using-Avaz-to-wish-Happy-Fathers-Day.jpg}};
}
\begin{frame}
...
{
\usebackgroundtemplate{
	\tikz[overlay,remember picture] \node[opacity=0.35,  xshift=4.9cm, yshift=-3.0cm, at=(current page.center)] {
		\includegraphics[scale=0.05]{images/Avaz.png} };
}
\begin{frame}
...
{
\usebackgroundtemplate{
	\tikz[overlay,remember picture] \node[opacity=0.35,  xshift=4.7cm, yshift=-2.8cm, at=(current page.center)] {
		\includegraphics[scale=.25]{images/copyright.jpg}};
}
\begin{frame}
